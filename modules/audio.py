# Audio cog for the Clopper Rewrite.
# Uses discord.py
import asyncio
import discord
...
class GeneralAudioError(Exception):
    """The base error for all audio cog errors."""
    pass


class AudioRetrievalFail(Exception):
    pass
...
class Audio:
    ...
    async def join(self, ctx, *, channel : discord.Channel):
        ...
        try:
            ...
            await self.bot.say(':white_check_mark: Ready to play audio in ' + channel.name + '!')
    ...
    async def play(self, ctx, *, song : str):
        ...
        try:
            player = await state.voice.create_ytdl_player(song, ytdl_options=ytdl_options, after=state.toggle_next)
        except Exception as e:
            fmt = ':x: An error occurred while processing this request: ```py\n{}: {}\n```'
    ...
    async def volume(self, ctx, value : int):
        ...
        if state.is_playing():
            ...
            await self.bot.say(':loudspeaker: I have set the volume to {:.0%}.'.format(player.volume))
